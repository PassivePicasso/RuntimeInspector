...
namespace RuntimeInspectorNamespace
{
    ...
    public static class RuntimeInspectorUtils
    {
        ...
        public static void ShowTooltip(string tooltip, PointerEventData pointer, UISkin skin = null, Canvas referenceCanvas = null)
        {
            ...
            if (!tooltipPopup)
            {
                tooltipPopup = (Tooltip)Object.Instantiate(RIP.Assets.OfType<GameObject>().First(go => go.GetComponent<Tooltip>()).GetComponent<Tooltip>(), popupCanvas.transform, false);
        ...
        public static DraggedReferenceItem CreateDraggedReferenceItem(Object reference, PointerEventData draggingPointer, UISkin skin = null, Canvas referenceCanvas = null)
        {
            ...
            else
            {
                ...
                referenceItem = (DraggedReferenceItem)Object.Instantiate(RIP.Assets.OfType<GameObject>().First(go => go.GetComponent<DraggedReferenceItem>()).GetComponent<DraggedReferenceItem>(), popupCanvas.transform, false);
                hasCanvasChanged = true;
            }
