...
namespace RuntimeInspectorNamespace
{
	...
	{
        public static Func<ColorPicker> LoadColorPicker = () => Resources.Load<ColorPicker>("RuntimeInspector/ColorPicker");
		public static Func<ObjectReferencePicker> LoadObjRefPicker = () => Resources.Load<ObjectReferencePicker>("RuntimeInspector/ObjectReferencePicker");
		public static Func<DraggedReferenceItem> LoadDraggedReferenceItem = () => Resources.Load<DraggedReferenceItem>("RuntimeInspector/DraggedReferenceItem");
		public static Func<Tooltip> LoadTooltip = () => Resources.Load<Tooltip>("RuntimeInspector/Tooltip");
		...
		public static void ShowTooltip( string tooltip, PointerEventData pointer, UISkin skin = null, Canvas referenceCanvas = null )
		{
			...
			if( !tooltipPopup )
			{
				tooltipPopup = (Tooltip) Object.Instantiate(LoadTooltip(), popupCanvas.transform, false );
		...
		public static DraggedReferenceItem CreateDraggedReferenceItem( Object reference, PointerEventData draggingPointer, UISkin skin = null, Canvas referenceCanvas = null )
		{
			...
			{
				referenceItem = (DraggedReferenceItem) Object.Instantiate(LoadDraggedReferenceItem(), popupCanvas.transform, false );
				hasCanvasChanged = true;
			}
