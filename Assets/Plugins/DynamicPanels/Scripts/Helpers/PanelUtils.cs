...
namespace DynamicPanels
{
	...
	{
		public static System.Func<PanelTab> LoadTab = () => Resources.Load<PanelTab>("DynamicPanelTab");
		public static System.Func<Panel> LoadPanel = () => Resources.Load<Panel>("DynamicPanel");
		public static System.Func<RectTransform> LoadPanelPreview = () => Resources.Load<RectTransform>("DynamicPanelPreview");
		internal static class Internal
		{
			public static Panel CreatePanel( RectTransform content, DynamicPanelsCanvas canvas )
			{
				...
				if( result == null )
				{
					result = (Panel) Object.Instantiate(LoadPanel(), canvas.RectTransform, false );
